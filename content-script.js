$(function() {
    ...
    function createButton(tweetID) {
        let str = '<div class="ProfileTweet-action ProfileTweet-action--CNB js-toggleState">' +
            ...
            '<div class="IconContainer js-tooltip" data-original-title="Know More">' +
            '<span class="Icon Icon--CNB"></span>' +
            '<span class="u-hiddenVisually">Know More Bot</span>' +
            '</div>' +
            '<span class="ProfileTweet-actionCount">' +
            '<span class="ProfileTweet-actionCountForPresentation" aria-hidden="true">Know More</span>' +
            '</span>' +
            '</button>' +
            '</div>';
